...
const DashHeader =  () => {
    ...
    <nav className="bg-white dark:bg-gray-800 py-2 w-[85vw]">
                    ...
                    <div className="flex items-center sm:ml-4 md:ml-6">
                                <div className="relative sm:ml-3 flex gap-5">
                                    <div className='flex justify-center items-center'>
                                            <button type="button" className="  flex items-center justify-center w-full rounded-md  sm:px-2 py-2 text-sm font-medium text-gray-700 dark:text-gray-50 hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-gray-500"
